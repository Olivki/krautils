 ...
 *
 * Note that this function has no support for the `withDefault` instances, as those are hidden and we can't check for
 * those. If support for those instances are required, use [Map.getValue] instead.
 *
 * @see [Map.getValue]
 */
@Suppress("UNCHECKED_CAST")
public inline fun <K, V> Map<K, V>.getOrThrow(key: K, lazyMessage: () -> Any): V = when (key) {
